...
function Card({title,color,description}) {
  ...
  return (
    <div className='border-2  flex flex-col items-center rounded-lg cursor-pointer hover:scale-[1.03] transition ease-in duration-150 h-full' data-aos="fade-right" data-aos-duration="700">
